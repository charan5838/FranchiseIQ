      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-between gap-2.5 pt-2.5 border-t border-slate-800/60">
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            <button
              onClick={() => handleOpenDetail(f.franchise_id)}
              className="px-3 py-1.5 rounded-lg bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold text-xs transition-colors flex items-center gap-1 cursor-pointer shadow-sm"
            >
        ...
        <div className="lg:col-span-4 space-y-5">
          <div className="bg-slate-900/35 border border-slate-800/60 rounded-xl p-4 sm:p-5 shadow-sm space-y-4 backdrop-blur-sm">
            ...
            <button
              onClick={runAnalysis}
              disabled={loading}
              className="w-full py-2.5 rounded-lg bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold text-xs transition-colors flex items-center justify-center gap-2 cursor-pointer mt-2 shadow-sm"
            >
              {loading ? (
