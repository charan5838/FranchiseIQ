      ...
      <div
        ...
        className={`bg-slate-900/35 hover:bg-slate-900/45 rounded-xl border transition-all p-4 sm:p-5 shadow-sm space-y-3.5 backdrop-blur-sm ${
          isTop 
            ...
            : 'border-slate-100 dark:border-slate-800/60 hover:border-slate-700/80'
        }`}
      >
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">{f.sector_name} • {f.sub_sector}</p>
            </div>
          </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-2.5 pt-2.5 border-t border-slate-100 dark:border-slate-800/60">
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            <button
              onClick={() => handleOpenDetail(f.franchise_id)}
              className="px-3 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-semibold text-xs transition-colors flex items-center gap-1 cursor-pointer shadow-sm"
            >
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
        ...
        <div className="lg:col-span-4 space-y-5">
          <div className="bg-slate-900/35 border border-slate-100 dark:border-slate-800/60 rounded-xl p-4 sm:p-5 shadow-sm space-y-4 backdrop-blur-sm">
            ...
            <div className="space-y-3">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-950/60 border border-slate-200/80 dark:border-slate-800/70 rounded-lg px-3 py-2 text-xs text-white focus:border-emerald-500/80 outline-none"
                >
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-950/60 border border-slate-200/80 dark:border-slate-800/70 rounded-lg px-3 py-2 text-xs text-white focus:border-emerald-500/80 outline-none font-medium"
                >
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-950/60 border border-slate-200/80 dark:border-slate-800/70 rounded-lg px-3 py-2 text-xs text-emerald-400 font-semibold focus:border-emerald-500/80 outline-none"
                >
            ...
            <button
              onClick={runAnalysis}
              disabled={loading}
              className="w-full py-2.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-semibold text-xs transition-colors flex items-center justify-center gap-2 cursor-pointer mt-2 shadow-sm"
            >
              {loading ? (
        ...
        <div className="lg:col-span-8 space-y-5">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 bg-slate-900/30 p-3.5 rounded-xl border border-slate-100 dark:border-slate-800/60 backdrop-blur-sm">
            <div>
              <span className="text-xs text-slate-500 dark:text-slate-400">Target Strategy:</span>
          ...
          <div className="bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-slate-200 dark:border-slate-800 rounded-xl p-3.5 shadow-sm space-y-2.5 backdrop-blur-sm">
          ...
          <div className="bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-slate-200 dark:border-slate-800 rounded-xl p-3.5 shadow-sm space-y-3 backdrop-blur-sm">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-1 border-t border-slate-100 dark:border-slate-800/60 text-xs">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-950/60 border border-slate-200/80 dark:border-slate-800/70 rounded-lg px-2.5 py-1.5 text-xs text-white focus:outline-none focus:border-emerald-500/80 font-medium"
                >
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-950/60 border border-slate-200/80 dark:border-slate-800/70 rounded-lg px-2.5 py-1.5 text-xs text-white focus:outline-none focus:border-emerald-500/80"
                >
          ...
          {filteredAndSortedResults.length === 0 && !loading && (
            <div className="text-center py-12 bg-slate-900/40 rounded-2xl border border-slate-800">
              ...
              <h3 className="text-base font-bold text-slate-900 dark:text-white">No matching franchises found</h3>
            ...
            <div className="space-y-6">
              {sectorGroups.map((group) => (
                <div key={group.sectorName} className="space-y-3">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3 bg-slate-900/35 p-3.5 rounded-xl border border-slate-100 dark:border-slate-800/60 shadow-sm backdrop-blur-sm">
