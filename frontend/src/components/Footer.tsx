...
export const Footer: React.FC<{ setCurrentPage?: (page: string) => void }> = ({ setCurrentPage }) => {
  return (
    <footer className="bg-white dark:bg-[#070b14] border-t border-slate-200 dark:border-slate-800/80 mt-16 text-xs text-slate-600 dark:text-slate-400 transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-400">
              ...
              <li><button onClick={() => setCurrentPage?.('simulator')} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors cursor-pointer">Scenario Stress-Test</button></li>
              <li><button onClick={() => setCurrentPage?.('location')} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors cursor-pointer">Location Intelligence</button></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-400">
              ...
              <li><span className="text-rose-600 dark:text-rose-400 font-medium">🔴 Marketing Claims</span></li>
              <li><button onClick={() => setCurrentPage?.('watchlist')} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors cursor-pointer">My Watchlist</button></li>
            </ul>
          </div>
        </div>
