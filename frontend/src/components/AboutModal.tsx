...
export const AboutModal: React.FC<AboutModalProps> = ({ isOpen, onClose, setCurrentPage }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div 
        className="bg-slate-900 border border-slate-800 rounded-2xl max-w-xl w-full p-6 sm:p-7 shadow-2xl space-y-5 relative"
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-1">
          <div className="p-3.5 rounded-xl bg-slate-800/60 border border-slate-800">
            ...
            <h4 className="text-xs font-bold text-white">4-Tier Verification</h4>
          ...
          <div className="p-3.5 rounded-xl bg-slate-800/60 border border-slate-800">
            ...
            <h4 className="text-xs font-bold text-white">Claim Gap Audits</h4>
            <p className="text-[11px] text-slate-400 mt-1 leading-snug">
        ...
        <div className="pt-2 border-t border-slate-800 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-4 py-2 rounded-lg bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold text-xs transition-colors flex items-center gap-1.5 shadow-sm"
            >
